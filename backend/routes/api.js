...
router.get('/kpi/sedes', kpiController.listSedes);
router.post('/kpi/sedes', kpiController.createSede);
router.put('/kpi/sedes/:id', kpiController.updateSede);
router.delete('/kpi/sedes/:id', kpiController.deleteSede);
